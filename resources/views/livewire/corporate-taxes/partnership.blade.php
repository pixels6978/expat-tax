<div>
    ...
    <div class="mt-5" id="general_partnership_information">
        ...
        <div class="mt-3">
            ...
            <input type="text" wire:model="EIN" class="form-control business-income-semi-input" name="">
        </div>
        ...
        <div class="mt-3">
            ...
            <input type="text" wire:model="PricipalBusinessActivity" class="form-control business-income-name-input" name="">
        </div>

        <div class="mt-3">
            <label class="mb-2" for="">Formation date of Partnership:
                @error('PartnershipDate') <span class="error text-danger">*</span>
                @enderror
            </label>
            <input type="date" wire:model="PartnershipDate" class="form-control business-income-date-input" name="">
        </div>
        ...
        <div class="mt-3">
            ...
            <div class="row">
                <div class="col-md-6">
                    <label class="mb-2" for="">Name @error('PartnerName') <span
                        class="error text-danger">*</span> @enderror
                    </label>
                    <input type="text" wire:model.lazy='PartnerName' class="form-control" name="">
                </div>
                <div class="col-md-6">
                    <label class="mb-2" for="">Address @error('PartnerAddress') <span
                        class="error text-danger">*</span> @enderror
                    </label>
                    <input type="text" wire:model.lazy='PartnerAddress' class="form-control" name="">
                </div>
